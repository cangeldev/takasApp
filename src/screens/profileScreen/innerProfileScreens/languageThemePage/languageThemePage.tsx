...
import { LanguageItem, ThemeItem } from 'components/profileScreenComponents/innerProfileScreenComponents/languageThemePageComponents/languageAndThemeItems'
...
export const LanguageThemePage = () => {
    ...
    return (
        <ScrollView style={styles.container}>
            <CustomHeader headerTitle={"languageAndThemeSettings"} />
