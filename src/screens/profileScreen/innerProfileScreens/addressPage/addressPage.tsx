...
import { AddAddressModal, AddressCard } from 'components/profileScreenComponents/innerProfileScreenComponents/addressPageComponents'
...
export const AddressPage = () => {
    ...
    return (
        <View style={styles.container}>
            <CustomHeader headerTitle={"addressAndLocationInformation"} />
...
const SavedAddressesSection = () => {
    ...
    return (
        <View style={styles.SavedAddressesSectionContainer}>
            <CustomHeader addAddressVisible={true} headerTitle={"addressInformation"} />
            <AddressCard
                title="Ev Adresim"
                addressDetails={[
                    "Can GEL",
